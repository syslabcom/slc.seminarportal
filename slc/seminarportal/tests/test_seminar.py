...
class TestSeminar(SeminarPortalTestCase):
    ...
    def test_seminarportal(self):
        """ Test Seminar creation and succesful automatic creation of
            subfolders.
        """
        portal = self.portal
        sid = portal.generateUniqueId('SPSeminar')
        portal.invokeFactory('SPSeminar', sid, title="Seminar")
        seminar = getattr(portal, sid)
